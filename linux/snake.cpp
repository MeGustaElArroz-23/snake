...
#define KEY_UP 65 //27 91 65
#define KEY_DOWN 66 //66
#define KEY_LEFT 68 //68
#define KEY_RIGHT 67 //67
...
bool run(){
    ...
    //for (int i=0;i<debuglist.size();i++) cerr << debuglist[i] << ' ';
    //cerr << debuglist.size()<< '\n';
    //debuglist.clear();
